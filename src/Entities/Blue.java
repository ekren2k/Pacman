...
public class Blue extends Ghost {
    ...
    public Blue(MainPanel mp, Pacman pacman) {
        super(mp, pacman);
        defaultSpeed = 3;
        this.pacman = pacman;
        this.mp = mp;
    ...
    protected void loadAndScaleImages(){
        try {
            right1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/blueright1.png"));
            left1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/blueleft1.png"));
            down1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/bluedown1.png"));
            up1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/blueup1.png"));
