...
public class Red extends Ghost {
    ...
    boolean isBlocked;
    public Red(MainPanel mp, Pacman pacman) {
        super(mp, pacman);
        defaultSpeed = 3;
        this.mp = mp;
        this.pacman = pacman;
    ...
    protected void loadAndScaleImages(){
        try {
            right1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/redright1.png"));
            left1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/redleft1.png"));
            down1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/reddown1.png"));
            up1_b = ImageIO.read(getClass().getResourceAsStream("/sprites/redup1.png"));
